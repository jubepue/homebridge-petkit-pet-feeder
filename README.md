...
|               model               | string |    no    |                'D4'                        |      'FeederMini',<br>'Feeder',<br>'D4' | Petkit Feeder Mini: 'FeederMini'<br>Petkit Feeder Element: 'Feeder'<br>Petkit Feeder Element SOLO: 'D4'<br>Petkit Feeder Element Infiniti: 'D3' |
